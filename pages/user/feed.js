  ...
  return (
    <>
      ...
      <div style={{ textAlign: "center", margin: "12px" }}>
        {props?.item.image && <Image src={props?.item.image} width={300} />}
      </div>
      <div>
        <Text>
        ...
        return (
          <div style={{ margin: "12px" }}>
            <div style={{ display: "inline-block", margin: "6px" }}>
              <Button
                type="text"
                style={{ backgroundColor: "initial", padding: "0px" }}
              >
                <Avatar
                  size={30}
            ...
            <div style={{ display: "inline-block" }}>
              ...
              >
                ...
                >
                  <Title level={5}>
                    {v.commenter.firstName + " " + v.commenter.lastName}
                  </Title>
                </Button>
                <Text>
              ...
              <div style={{ margin: "12px" }}>
                {v.image && <Image src={v.image} width={180} />}
              </div>
            </div>
          </div>
        );
